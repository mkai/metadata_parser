...
PARSE_SAFE_FILES = ('html', 'txt', 'json', 'htm', 'xml', 'php', 'asp', 'aspx',
                    'ece', 'xhtml', 'cfm', 'cgi')
...
class MetadataParser(object):
    ...
    def is_opengraph_minimum(self):
        """
        Returns true/false if the page has the minimum amount of opengraph
        tags.
    ...
    def get_metadata(self, field, strategy=None):
        """
        Looks for the given field in various stores.

        Defaults to the core strategy, though you may specify a certain item.
        If you search for 'all' it will return a dict of all values.
